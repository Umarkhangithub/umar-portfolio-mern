              ...
              <tbody>
                {skills.map((skill, index) => (
                  <tr key={skill._id} className="hover:bg-gray-50 text-gray-700">
                    ...
                    <td className="px-4 py-2 border">{skill.name}</td>
                    <td className="px-4 py-2 border">{skill.category}</td>
                    <td className="px-4 py-2 border">{skill.level}</td>
